...
NumberW_1 -> AnyWord<wff=/[1-9]?[1-9]-?((ый)|(ий)|(ой)|й)/> {outgram="муж,ед,им"};
NumberW_2 -> AnyWord<wff=/[1-9]?[1-9]-?((ая)|(яя)|(ья)|я)/> {outgram="жен,ед,им"};
NumberW_3 -> AnyWord<wff=/[1-9]?[1-9]-?((ее)|(ье)|(ое)|е)/> {outgram="сред,ед,им"};
